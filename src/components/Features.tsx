  ...
  return (
    <section ref={elementRef} id="about" className="border-t border-[var(--border)] bg-[var(--background)] py-24 px-6">
      <div className="mx-auto max-w-6xl">
        <h2 className={`text-3xl font-bold tracking-tight text-[var(--foreground)] sm:text-4xl ${isVisible ? "animate-fade-in-left" : "opacity-0"}`}>
          What I do
        </h2>
        <p className={`mt-4 max-w-2xl text-lg text-[var(--muted)] text-justify ${isVisible ? "animate-fade-in-left" : "opacity-0"}`} style={{ animationDelay: "0.1s" }}>
